...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.last_active'
        db.alter_column(u'users_profile', 'last_active', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.last_active'
        db.alter_column(u'users_profile', 'last_active', self.gf('django.db.models.fields.DateTimeField')(default=None))
